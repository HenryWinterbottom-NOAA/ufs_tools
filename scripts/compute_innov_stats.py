...
-----
    ...
    user@host:$ python compute_innov_stats --<yaml_file> --<cycle> --<app> \
                    [--expt_name]
...
from exceptions import InnovStatsComputeError
from innov_stats.compute import gsi_atmos, soca_ice, soca_ocean
...
@msg_except_handle(InnovStatsComputeError)
